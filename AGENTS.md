...
# Start agent-server in Docker (software-agent-sdk v1.39.0)
...
- The integration workflow pins `ghcr.io/openhands/agent-server:1.39.0-python`, which corresponds to the `software-agent-sdk` release `v1.39.0`.
