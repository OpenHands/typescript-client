...
export declare namespace EventSortOrder {
    /** @deprecated Use TIMESTAMP_DESC instead. */
    const REVERSE_TIMESTAMP: EventSortOrder;
}
/**
 ...
 */
export declare enum ConversationExecutionStatus {
    IDLE = "idle",
    RUNNING = "running",
    PAUSED = "paused",
 ...
 */
export declare const AgentExecutionStatus: typeof ConversationExecutionStatus;
