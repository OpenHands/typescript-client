 ...
 */
export type HookExecutionEventType = 'PreToolUse' | 'PostToolUse' | 'UserPromptSubmit' | 'SessionStart' | 'SessionEnd' | 'Stop';
/**
 ...
 */
export type ConversationEvent = MessageEvent | ActionEvent | ObservationEvent | AgentErrorEvent | SystemPromptEvent | PauseEvent | CondensationRequestEvent | CondensationSummaryEvent | CondensationEvent | ConversationStateUpdateEvent | ConversationErrorEvent | LLMCompletionLogEvent | UserRejectObservation | ConfirmationRequestEvent | ConfirmationResponseEvent | TokenEvent | StuckDetectionEvent | FinishEvent | ThinkEvent | HookExecutionEvent;
/**
 * Type guard to check if an event is a MessageEvent
 */
export declare function isMessageEvent(event: BaseEvent): event is MessageEvent;
/**
 * Type guard to check if an event is an ActionEvent
 */
export declare function isActionEvent(event: BaseEvent): event is ActionEvent;
/**
 * Type guard to check if an event is an ObservationEvent
 */
export declare function isObservationEvent(event: BaseEvent): event is ObservationEvent;
/**
 * Type guard to check if an event is an AgentErrorEvent
 */
export declare function isAgentErrorEvent(event: BaseEvent): event is AgentErrorEvent;
/**
 * Type guard to check if event is observation-like (has action_id)
 */
export declare function isObservationLike(event: BaseEvent): event is ObservationEvent | AgentErrorEvent | UserRejectObservation;
/**
 * Type guard to check if an event is a ConversationErrorEvent
 */
export declare function isConversationErrorEvent(event: BaseEvent): event is ConversationErrorEvent;
/**
 * Type guard to check if an event is a CondensationEvent
 */
export declare function isCondensationEvent(event: BaseEvent): event is CondensationEvent;
/**
 * Type guard to check if an event is a HookExecutionEvent
 */
export declare function isHookExecutionEvent(event: BaseEvent): event is HookExecutionEvent;
/**
 ...
 */
export declare function createBaseEvent(kind: string, source?: EventSource): BaseEvent;
