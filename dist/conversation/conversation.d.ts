...
import { LocalConversationOptions } from './local-conversation';
 ...
 * ```
 */
export declare class Conversation extends RemoteConversation {
 ...
 */
export declare function createConversation(config: CreateConversationOptions): IConversation;
/**
 ...
 * @returns A conversation instance implementing IConversation
 */
export declare function createConversationAuto(agent: AgentBase, workspace: IWorkspace, options?: ConversationOptions): IConversation;
