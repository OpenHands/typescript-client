...
export function createLLM(config) {
    switch (config.provider) {
        case 'openrouter':
            return new OpenRouterLLM(config.options);
        case 'openai':
            // TODO: Implement OpenAI direct support
            throw new Error('OpenAI direct support not yet implemented. ' +
                'Use OpenRouter with openai/* models instead.');
        case 'anthropic':
            // TODO: Implement Anthropic direct support
            throw new Error('Anthropic direct support not yet implemented. ' +
