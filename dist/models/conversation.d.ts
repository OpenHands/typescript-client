 ...
 */
import { ConversationID, ConversationExecutionStatus, AgentExecutionStatus, ConfirmationPolicyBase, ConversationStats, AgentBase, Message } from '../types/base';
import type { HookConfig } from '../hooks';
export declare enum ConversationSortOrder {
